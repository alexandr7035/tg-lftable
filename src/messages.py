...
def main_menu_message():
    ...
    text += 'Чтобы отключить все уведомления, введите команду /stop\n'
...
def stop_message():
    text = '🔕 Отключены все уведомления. 🔕 \n'
    text += 'Если они снова понадобятся, введите команду /start и настройте их в меню.'
